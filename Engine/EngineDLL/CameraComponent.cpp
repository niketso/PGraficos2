...
CameraComponent::CameraComponent(Renderer * render)
{
	r1 = render;
...
void CameraComponent::Pitch(float dir)
{
...
void CameraComponent::yaw(float dir)
{
	//fijo up
...
void CameraComponent::Roll(float dir)
{
	//fijo forward
